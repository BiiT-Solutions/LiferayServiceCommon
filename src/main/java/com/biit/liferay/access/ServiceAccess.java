...
public abstract class ServiceAccess<Type, LiferayType extends Type> implements LiferayService, IServiceAccess {
	...
	@Override
	public void authorizedServerConnection(String host, String protocol, int port, String webservicesPath,
	 ...
	 */
	public String getHttpResponse(String proxyPrefix, String webService, List<NameValuePair> params)
			throws ClientProtocolException, IOException, NotConnectedToWebServiceException, AuthenticationRequired {
		return getHttpResponse(proxyPrefix, webService, params, true);
	}

	private String getHttpResponse(String proxyPrefix, String webService, List<NameValuePair> params,
		...
		proxyPrefix = parseProxyPrefix(proxyPrefix);
