...
public class UserService extends ServiceAccess<IUser<Long>, User> implements IUserService {
    ...
    public void authorizedServerConnection(String address, String protocol, int port, String proxyPrefix, String webservicesPath,
        ...
        contactService.authorizedServerConnection(address, protocol, port, proxyPrefix, webservicesPath, authenticationToken,
                loginUser, password);
        // A service is a mix of the organization service and the user service.
        organizationService = new OrganizationService();
        organizationService.authorizedServerConnection(address, protocol, port, proxyPrefix, webservicesPath, authenticationToken,
                loginUser, password);
    }
     ...
     *
     * @param company      liferay portal where look up for.
     ...
     *
     * @param company    liferay portal where look up for.
     * @param screenName is a unique token that identifies a liferay user from another,
