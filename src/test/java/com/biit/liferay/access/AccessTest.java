...
public class AccessTest {
    private final static String LOGIN_USER = "webservices@biit-solutions.com";
    private final static String LOGIN_PASSWORD = "asd123";
    private final static String HOST = "jenkins.biit-solutions.com";
    ...
    private final static String COMPANY_VIRTUALHOST = "jenkins.biit-solutions.com";
    ...
    private Organization organization1, organization2, organization3;
    private Site site;
    ...
    public void notAuthorized() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError {
        companyService.authorizedServerConnection(HOST, LIFERAY_PROTOCOL, PORT, PROXY_PREFIX, WEBSERVICES_PATH, AUTHENTICATION_TOKEN, LOGIN_USER + "failure", LOGIN_PASSWORD
                + "failure");
        try {
    ...
    public void authorized() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError {
    ...
    public void classNameAccess() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError {
        classNameService.authorizedServerConnection(HOST, LIFERAY_PROTOCOL, PORT, PROXY_PREFIX, WEBSERVICES_PATH, AUTHENTICATION_TOKEN, LOGIN_USER, LOGIN_PASSWORD);
    ...
    public void companyAccessFailure() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError {
        companyService.getCompanyByVirtualHost(COMPANY_VIRTUALHOST + "_failure");
    }
    ...
    public void siteAccess() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError {
    ...
    public void notConnectedToUserWebService() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
    ...
    public void userNotExistsById() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError, UserDoesNotExistException {
        user = (User) userService.getUserById(1111);
    }

    @Test(groups = {"userAccess"}, dependsOnMethods = {"userAdd"}, dependsOnGroups = {"companyAccess"}, expectedExceptions = {UserDoesNotExistException.class})
    public void userNotExistsByEmail() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError, UserDoesNotExistException {
        user = (User) userService.getUserByEmailAddress(company, TEST_USER_MAIL + "_bad");
    }

    @Test(groups = {"userAccess"}, dependsOnMethods = {"userAdd"}, dependsOnGroups = {"companyAccess"}, expectedExceptions = {UserDoesNotExistException.class})
    public void userNotExistsByScreenName() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError, UserDoesNotExistException {
        user = (User) userService.getUserByScreenName(company, "badUser");
    }

    @Test(groups = {"userAccess"}, dependsOnMethods = {"userAccess"})
    public void userEdit() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired, WebServiceAccessError,
            UserDoesNotExistException {
        // Change some fields.
    ...
    public void connectToContactWebService() {
        contactService.authorizedServerConnection(HOST, LIFERAY_PROTOCOL, PORT, PROXY_PREFIX, WEBSERVICES_PATH, AUTHENTICATION_TOKEN, LOGIN_USER, LOGIN_PASSWORD);
    ...
    public void getUserBirthday() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired, WebServiceAccessError {
    ...
    public void groupDuplicated() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError, DuplicatedLiferayElement {
        group = (UserGroup) userGroupService.addUserGroup(TEST_GROUP, "");
    }
    ...
    public void addOrganization() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
    ...
    public void organizationDuplicated() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError, DuplicatedLiferayElement {
        organization1 = (Organization) organizationService.addOrganization(company, TEST_ORGANIZATION_1);
    }

    @Test(groups = {"organizationAccess"}, dependsOnMethods = {"addOrganization"})
    public void getOrganizationById() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError {
    ...
    @Test(groups = {"organizationAccess"}, dependsOnMethods = {"addOrganization"})
    public void updateOrganization() throws IOException, NotConnectedToWebServiceException, WebServiceAccessError,
    ...
    public void assignUsersToOrganizations() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired {
    ...
    public void checkUsersOfOrganization() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired {
    ...
    @Test(groups = {"organizationAccess"}, dependsOnMethods = {"assignUsersToOrganizations", "userAccess"})
    public void getOrganizationsWithoutParent() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired {
    ...
    @Test(groups = {"organizationAccess"}, dependsOnMethods = {"assignUsersToOrganizations", "userAccess"})
    public void getOrganizationsWithParent() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError, DuplicatedLiferayElement {
    ...
    @Test(groups = {"organizationAccess"}, dependsOnMethods = {"assignUsersToOrganizations", "userAccess"})
    public void checkOrganizationsOfUser() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired {
    ...
    public void userAccessPool() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired, WebServiceAccessError,
            UserDoesNotExistException {
    ...
    public void groupAccessPool() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired {
        // Make a connection to populate the pool.
    ...
    public void organizationsAccessPool() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            WebServiceAccessError {
    ...
    public void setOrganizationsBySiteAndUser() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired {
        // Make a connection for populating the pool.
    ...
    public void getOrganizationsByUserPool() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
    ...
    @Test(groups = {"pool"}, dependsOnMethods = {"setOrganizationsBySiteAndUser"})
    public void getOrganizationsBySiteAndUserPool() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
    ...
    @Test(alwaysRun = true, groups = {"clearData"}, dependsOnGroups = {"groupAccess", "userAccess", "organizationAccess"}, dependsOnMethods = {"userEdit",
            "addOrganization"})
    public void unsetUserFromOrganization() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired {
        ...
        int usersInOrg3 = organizationService.getOrganizationUsers(organization3).size();
        ...
        organizationService.removeUserFromOrganization(user, organization3);
        ...
        Assert.assertEquals(usersInOrg3 - 1, organizationService.getOrganizationUsers(organization3).size());
    }

    @Test(alwaysRun = true, groups = {"clearData"}, dependsOnMethods = {"unsetUserFromOrganization"})
    public void organizationDelete() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired,
            OrganizationNotDeletedException {
        int prevOrgs = organizationService.getOrganizations(company).size();
        organizationService.deleteOrganization(company, organization3);
        organizationService.deleteOrganization(company, organization1);
        organizationService.deleteOrganization(company, organization2);
        Assert.assertEquals(prevOrgs - 3, organizationService.getOrganizations(company).size());
    }
    ...
    public void siteDelete() throws NotConnectedToWebServiceException, IOException, AuthenticationRequired, WebServiceAccessError {
